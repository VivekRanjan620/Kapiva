      ...
      >
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center overflow-x-auto scrollbar-hide px-7 py-2 gap-2">
            {mobileCategories.map((cat, index) => (
              <div key={cat.label} className="flex items-center shrink-0">
                <div className="flex flex-col items-center gap-1 cursor-pointer">
                  <div className="w-12 h-12 bg-gray-100 overflow-hidden flex items-center justify-center border border-gray-200 rounded-full">
                    <img
                      src={cat.icon}
                      alt={cat.label}
            ...
            <div className="shrink-0 text-gray-400 text-lg font-bold ml-1">
              ›
            </div>
          </div>
        </div>
