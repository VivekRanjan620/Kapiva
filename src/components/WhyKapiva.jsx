...
const newsItems = [
  { id: 1, logoText: "YourStory", description: "Most Admired D2C Brand of the Year in the Fitness & Wellness category.", logo: null },
  { id: 2, logoText: "CNBC", description: "Featured Kapiva's Plans for Global Expansion", logo: null },
  { id: 3, logoText: "The Week", description: "Featured Kapiva's brand film launch with Malaika Arora", logo: null },
  { id: 4, logoText: "Washington Times", description: "Featured Kapiva Dia Free Juice as a solution to manage Diabetes", logo: null },
  { id: 5, logoText: "Economic Times", description: "Featured Kapiva building the Ingestible Skincare Trend", logo: null },
  { id: 6, logoText: "Forbes", description: "Kapiva among top 10 wellness brands in India", logo: null },
  { id: 7, logoText: "Inc42", description: "Kapiva raises funding to expand product portfolio", logo: null },
  { id: 8, logoText: "Mint", description: "Kapiva's Ayurvedic products gain popularity among millennials", logo: null },
  { id: 9, logoText: "Hindu", description: "Kapiva revolutionizing traditional Ayurveda for modern consumers", logo: null },
  { id: 10, logoText: "Business Today", description: "Kapiva named best wellness startup of the year", logo: null },
];
    ...
    <>
      ...
      <div className="bg-white py-16 px-4 relative overflow-hidden">
        ...
        <div className="absolute left-0 top-1/4 pointer-events-none select-none">
          <div className="text-8xl" style={{ transform: "rotate(-20deg)" }}>🌿</div>
          <div className="text-6xl mt-4" style={{ transform: "rotate(10deg)" }}>🌶️</div>
        </div>

        {/* Decorative — right */}
        <div className="absolute right-0 top-1/3 pointer-events-none select-none">
          <div className="text-8xl" style={{ transform: "rotate(20deg)" }}>🌸</div>
          <div className="text-6xl mt-4" style={{ transform: "rotate(-10deg)" }}>🍓</div>
        </div>

        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-12">Why Kapiva?</h2>
      ...
      <div className="bg-white py-12 px-4 border-t border-gray-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-4xl font-black" style={{ color: "#c8972a" }}>2M+</p>
          ...
          <div className="grid grid-cols-5 gap-3">
            {visibleNews.map((item) => (
              <div
                key={item.id}
                className="border border-gray-200 rounded-xl bg-white p-3 flex flex-col items-center text-center hover:shadow-md transition-shadow duration-200"
              >
                {/* Logo circle */}
          ...
          <div className="flex justify-center gap-2 mt-5">
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                style={{
                  width: i === newsPage ? 24 : 8,
                  height: 8,
                  background: i === newsPage ? "#1a1a1a" : "#cccccc",
                }}
              />
            ))}
          </div>
